...
public class BookingMaster {
    ...
    @Column(name ="bookingmasterpayurl")
    private String bookingMasterPayUrl;
    ...
    public String getBookingMasterPayUrl() {
        return bookingMasterPayUrl;
    }

    public void setBookingMasterPayUrl(String bookingMasterPayUrl) {
        this.bookingMasterPayUrl = bookingMasterPayUrl;
    }
