...
public class MemberController {
    ...
    String  memberSignupSave(Model model,
        ...
        try{
            ...
            String subject = "Activate User For Nida Booking";
            String body = "Welcome Nida Booking " + uReg.getUserFullName() + " Please Click Activate   http://localhost:8080/member/active/" + uReg.getUserId();
