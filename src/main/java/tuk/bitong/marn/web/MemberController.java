...
public class MemberController {
    ...
    String  memberSignupSave(Model model,
        ...
        try{
            ...
            String body = "Welcome Nida BookingMaster " + uReg.getUserFullName() + " Please Click Activate   http://110.170.171.138:8088/BookingProject/member/active/" + uReg.getUserId();
